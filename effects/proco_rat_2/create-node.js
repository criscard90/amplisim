...
const createFaustNode = async (audioContext, dspName = "template", voices = 0, sp = false, bufferSize = 512) => {
    ...
    // Base URL di questa directory del modulo. I fetch sotto usano percorsi assoluti
    // costruiti da import.meta.url: i percorsi relativi ('./dsp-meta.json') si
    // risolverebbero rispetto alla pagina che carica il modulo, non a questo file.
